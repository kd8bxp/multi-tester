 ...
 */
 ...
 int chargePin=8 ;        // pin to charge the capacitor - connected to one end of the charging resistor
...
message = "Multi-Tester";
messagedisplay(34,0);
message = "By LeRoy Miller";
messagedisplay(23,8);
message = "Based on:Companion IC";
messagedisplay(0,16);
message = "By: Srijal97";
messagedisplay(30,24);
delay(10000);
display.clearDisplay();
display.setTextSize(0);
}
